...
// OtherPluginsProvider — everything else (the manifest URL, fetching,
// seen-state, types) lives in that shared package.
export const SELF_PLUGIN_ID = "decky-apps-manager";
